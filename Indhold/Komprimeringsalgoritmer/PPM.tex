Komprimeringsmetoden blev udviklet af John Cleary og Ian Witten. De beskrev metoden i en artikel de udgav i 1984; "Data Compression Using Adaptive Coding and Partial String Matching" \cite{Cleary84datacompression}.
...
\caption{Pseudocode af PPM komprimering \cite{ppm_stringology}}
\label{pseudo_ppm}
\end{algorithm}