I forbindelse med projektet er der blevet tænkt over en række metoder, som gør os i stand til at finde ind til problemets kerne, og understøtte problemet i sin helhed.
Ud fra projektforslaget er det blevet fastsat at vores endelige løsning til problemet skal være en prototype af et program. Denne prototype skal være skrevet i C, og da problemstillingen omhandler SMS-beskeder, er det  SMS-mediets krav, som vi skal designe vores løsning efter.
...
\subsubsection{Intressentgruppernes brug af SMS'er}
...
Til dette vil en spørgeskema-undersøgelse være velegnet.